...
async function loadAll() {
  // Promise.all ব্যবহার করে সবগুলো ফাইল একসাথে লোড করা হচ্ছে
  await Promise.all([
    ...
    loadComponent('research-placeholder', 'research.html'),
    loadComponent('experience-placeholder', 'experience.html'),
    loadComponent('certifications-placeholder', 'certifications.html'),
    loadComponent('workshops-placeholder', 'workshops.html'),
    loadComponent('activities-placeholder', 'activities.html'),
    loadComponent('social-placeholder', 'social.html'),
    loadComponent('contact-placeholder', 'contact.html')
  ]);

  // সবগুলো ফাইল মুহূর্তের মধ্যে লোড হওয়ার পর অ্যানিমেশন শুরু হবে
  initAll();
}
